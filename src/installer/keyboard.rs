...
pub static KEYMAPS: &[Keymap] = &[
    ...
    // Swiss
    Keymap { id: "ch", label: "Swiss (Mixed)", console: "sg", xkb_layout: "ch", xkb_variant: None, aliases: &[] },
    Keymap { id: "ch-de", label: "Swiss (German)", console: "sg", xkb_layout: "ch", xkb_variant: Some("de"), aliases: &[] },
    Keymap { id: "ch-fr", label: "Swiss (French)", console: "sg", xkb_layout: "ch", xkb_variant: Some("fr"), aliases: &[] },
    ...
    // Middle East
    Keymap { id: "ara", label: "Arabic", console: "ar", xkb_layout: "ara", xkb_variant: None, aliases: &["ar"] },
    ...
    Keymap { id: "in", label: "Indian", console: "in", xkb_layout: "in", xkb_variant: None, aliases: &[] },
